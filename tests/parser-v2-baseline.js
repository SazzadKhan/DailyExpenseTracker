// tests/parser-v2-baseline.js
// FROZEN copy of js/features/assistant/parser.js as of commit 50df7a0 (parser v2).
// Used by tests/extreme-50.html to render live BEFORE/AFTER columns. Do not edit;
// the live parser is js/features/assistant/parser.js.
...
import { getLocalDateString, normalizeDateString } from '../js/core/format.js';
import { isIncomeCategory } from '../js/features/categories/categories.model.js';
