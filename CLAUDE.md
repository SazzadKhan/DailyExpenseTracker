...
- Don't read `docs/BUSINESS_PLAN*.md`, `docs/PITCHES.md`, or `docs/STRATEGY_NOTES_*.md` unless the task is explicitly about business docs — they are large and irrelevant to code work.
